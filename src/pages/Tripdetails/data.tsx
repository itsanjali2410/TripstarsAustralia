...
export const destinationsData = {
  ...
  malaysia: {
    ...
    kerala: {
      ...
      thingsToDo: [
        { name: "Backwater Cruise", image: kerala1 },
        { name: "Kathakali Performance", image: kerala2 },
        { name: "Munnar Tea Gardens", image: kerala3 },
        { name: "Wayanad Hills", image: kerala4 },
        { name: "Kovalam Beach", image: kerala5 },
        { name: "Periyar Wildlife Sanctuary", image: kerala6 },
    ...
    andaman: {
      ...
      thingsToDo: [
        { name: "Scuba Diving", image: andaman1 },
        { name: "Snorkeling at Elephant Beach", image: andaman2 },
        { name: "Havelock Island", image: andaman3 },
        { name: "Neil Island Exploration", image: andaman4 },
        { name: "Cellular Jail Visit", image: andaman5 },
        { name: "Ross Island Tour", image: andaman6 },
